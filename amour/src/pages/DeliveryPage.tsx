...
const DeliveryPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <header className="bg-[#0b74da] text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center text-white font-bold">D</div>
              <span className="text-lg font-bold tracking-wide">Delivery Dashboard</span>
            </div>
